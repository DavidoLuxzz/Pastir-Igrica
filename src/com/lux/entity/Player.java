...
public class Player extends Sprite {
    private int w,s,a,d;
    private double speed = NORMAL_SPEED; // px/gt
    public static final double NORMAL_SPEED = 3.0;
    public static final double COBWEB_SPEED = NORMAL_SPEED * 0.5;
    public static final double SPRINT_MULTIPLIER = 1.75;
    ...
    public void createCWOS(ArrayList<Drawable> objects){
        for (Drawable drw : objects){
            if (drw.isSolid())
                cos.add(drw);
            else if (drw.getTexture()==Drawable.TEXTURE_COBWEB)
                cws.add(drw);
        }
    }
